...
const locationSections = [
  {
    img: section2Image1,
    titleText: "청주 지북동 중심 입지<br />미래가치를 품은 주거환경",
    contentText:
      "청주시 상당구 지북동 247번지 일원<br />교통·생활·교육 인프라를 가까이 누리는 브랜드 아파트",
  },
  {
    img: section2Image2,
    titleText: "풍부한 생활 인프라<br />편리한 일상",
    contentText:
      "다양한 상업시설과 생활 편의시설을 가까이 누리는 생활권<br />편리하고 여유로운 일상을 완성하는 주거 환경",
  },
  {
    img: section2Image3,
    titleText: "청주 주요 생활권 연결<br />편리한 교통 환경",
    contentText:
      "주요 도로망을 통한 편리한 이동 환경<br />출퇴근과 일상을 더욱 여유롭게 만드는 교통 프리미엄",
  },
  {
    img: section2Image4,
    titleText: "교육과 생활을 모두 갖춘<br />청주 생활권",
    contentText:
      "교육시설과 다양한 생활 편의시설을 가까이 누리는 환경<br />가족 모두가 만족하는 쾌적한 주거 라이프를 제공합니다.",
  },
  {
    img: section2Image5,
    titleText: "한양건설 브랜드<br />프리미엄 아파트",
    contentText:
      "차별화된 단지 설계와 브랜드 노하우를 담은 주거 공간<br />청주 한양립스 더 벨루체의 품격 있는 라이프",
  },
  {
    img: section2Image6,
    titleText: "자연과 함께하는<br />프리미엄 라이프",
    contentText:
      "공원과 녹지 공간이 어우러진 쾌적한 주거환경<br />실거주 만족도와 미래가치를 함께 고려한 청주 한양립스 더 벨루체",
  },
];
        ...
        {locationSections.map((value) => (
          <LocationSectionBox
            ...
            onZoom={() =>
              openZoom(
                value.img,
                `청주 한양립스 ${value.titleText.replace(/<[^>]*>/g, " ")} 이미지`
              )
            }
          />
        ))}
