export const siteSeo = {
  ...
  defaultDescription:
    "청주 한양립스 공식 홈페이지입니다. 평택 고덕국제신도시 Abc-14BL·Abc-61BL 입지, 사업개요, 공급안내, 분양일정, 84㎡·101㎡ 평면도, E-모델하우스와 모델하우스 방문예약 정보를 확인하세요.",
  project: {
    addressCountry: "KR",
    addressRegion: "경기도",
    addressLocality: "평택시",
...
export const seoPages = {
  ...
  brandIntro: page({
    ...
    title: "브랜드소개 | 청주 한양립스",
    description:
      "청주 한양립스의 수자인·풍경채 브랜드 가치와 주거 철학을 소개합니다. 평택 고덕국제신도시에서 누리는 브랜드 아파트의 주거 가치를 확인하세요.",
    menu: "브랜드소개",
  }),
  brandVideo: page({
    path: "/Brand/video",
    title: "홍보영상 | 청주 한양립스",
    description:
      "청주 한양립스 홍보영상을 통해 평택 고덕국제신도시 Abc-14BL·Abc-61BL 입지와 브랜드 프리미엄, 단지의 주거 가치를 확인하세요.",
    menu: "브랜드소개",
  }),
  businessIntro: page({
    path: "/BusinessGuide/intro",
    title: "사업개요 | 청주 한양립스",
    description:
      "청주 한양립스 사업개요 안내입니다. 평택 고덕국제신도시 Abc-14BL·Abc-61BL, 총 1,126세대 규모, 전용 84㎡·101㎡ 중심의 브랜드 아파트 정보를 확인하세요.",
    menu: "사업개요",
  ...
  salesGuide: page({
    ...
    title: "공급안내 | 청주 한양립스",
    description:
      "청주 한양립스 공급안내 페이지입니다. 타입별 공급 구성, 모집공고, 분양 조건과 청약 전 확인해야 할 주요 정보를 안내합니다.",
    menu: "분양안내",
  }),
  salesInfoGuide: page({
    ...
    title: "분양안내 | 청주 한양립스",
    description:
      "청주 한양립스 분양안내 페이지입니다. 공급 정보, 청약 절차, 분양 일정과 계약 관련 주요 안내를 한눈에 확인하세요.",
    menu: "분양안내",
  }),
  ...
  announcement: page({
    ...
    title: "모집공고안내 | 청주 한양립스",
    description:
      "청주 한양립스 모집공고안내 페이지입니다. 공급 세대, 청약 일정, 계약 조건 등 분양 전 반드시 확인해야 할 공고 정보를 제공합니다.",
    menu: "분양안내",
  }),
  stampTax: page({
  ...
  locationIntro: page({
    ...
    title: "입지환경 | 청주 한양립스",
    description:
      "청주 한양립스 입지환경 안내입니다. 삼성 평택캠퍼스 직주근접, 평택 고덕국제신도시 생활권, 교통·교육·생활 인프라와 미래가치를 확인하세요.",
    menu: "입지환경",
  ...
  locationPremium: page({
    ...
    title: "프리미엄 | 청주 한양립스",
    description:
      "청주 한양립스 프리미엄 안내입니다. 평택 고덕국제신도시 중심 생활권, 삼성 평택캠퍼스 직주근접, 교통망과 브랜드 주거 가치를 소개합니다.",
    menu: "입지환경",
    image: "/img/og/location.jpg",
  }),
  complexIntro: page({
  ...
  floorPlan84A: page({
    ...
    description:
      "청주 한양립스 84A㎡ 평면도 안내입니다. 실거주 선호도가 높은 대표 타입의 공간 구성과 생활 동선을 확인하세요.",
    menu: "세대안내",
  }),
  floorPlan84C: page({
    path: "/FloorPlan/59B",
    title: "84C㎡ 평면도 | 청주 한양립스",
    description:
      "청주 한양립스 84C㎡ 평면도 안내입니다. 공간 활용과 수납, 가족 생활 동선을 고려한 세대 구성을 확인하세요.",
    menu: "세대안내",
  }),
  floorPlan101: page({
    path: "/FloorPlan/84A",
    title: "101㎡ 평면도 | 청주 한양립스",
    description:
      "청주 한양립스 101㎡ 평면도 안내입니다. 여유로운 중대형 타입의 공간감과 실내 구성을 확인하세요.",
    menu: "세대안내",
  }),
  floorPlan84B: page({
    path: "/FloorPlan/84B",
    title: "타입별 평면도 | 청주 한양립스",
    description:
      "청주 한양립스 타입별 평면도 안내입니다. 전용 84㎡·101㎡ 중심의 세대 구성과 공간 활용 포인트를 확인하세요.",
    menu: "세대안내",
  }),
  floorPlan114A: page({
    path: "/FloorPlan/114A",
    title: "세대안내 | 청주 한양립스",
    description:
      "청주 한양립스 세대안내 페이지입니다. 전용 84㎡·101㎡ 중심의 타입별 평면 구성과 주거 동선을 확인하세요.",
    menu: "세대안내",
  }),
  floorPlan114B: page({
    path: "/FloorPlan/114B",
    title: "세대안내 | 청주 한양립스",
    description:
      "청주 한양립스 세대안내 페이지입니다. 타입별 공간 구성, 수납 계획과 생활 동선 등 세대별 특장점을 확인하세요.",
    menu: "세대안내",
  }),
  floorPlanVideos: page({
    path: "/FloorPlan/videos",
    title: "세대안내영상 | 청주 한양립스",
    description:
      "청주 한양립스 세대안내영상 페이지입니다. 타입별 공간 구성과 실내 포인트를 영상으로 확인하세요.",
    menu: "세대안내",
  }),
  emodel: page({
    ...
    description:
      "청주 한양립스 E-모델하우스입니다. 84A㎡, 84C㎡, 101㎡ 타입의 실내 구조, 공간 구성과 주거 동선을 온라인으로 확인하세요.",
    menu: "세대안내",
  ...
  press: page({
    ...
    title: "언론보도 | 청주 한양립스",
    description:
      "청주 한양립스 언론보도 페이지입니다. 평택 고덕국제신도시 분양 소식, 사업 안내와 최신 홍보센터 정보를 확인하세요.",
    menu: "홍보센터",
    priority: 0.7,
  }),
  customer: page({
  ...
  notFound: page({
    ...
    description:
      "요청하신 페이지를 찾을 수 없습니다. 청주 한양립스 공식 홈페이지의 사업안내, 입지환경, 세대안내, E-모델하우스와 관심고객등록 메뉴를 이용해 주세요.",
    menu: "오류",
    priority: 0,
    changefreq: "yearly",
